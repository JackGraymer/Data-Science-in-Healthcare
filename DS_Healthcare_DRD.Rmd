...
```
**** 
(new description 22.10)
We conducted two separate Difference-in-Differences (DiD) models to evaluate the impact of Oregon’s decriminalization policy on drug-related deaths per 100,000 inhabitants, using California and Washington as individual control groups. This approach was motivated by the observed trends: Washington's trend closely follows Oregon’s, while California shows some divergence. Pre-policy correlations confirm that both states are appropriate controls under the parallel trends assumption:

Oregon and Washington: Pre-policy correlation of 0.790
Oregon and California: Pre-policy correlation of 0.750
Both correlations indicate that Washington and California provide valid benchmarks for assessing the policy’s effect.
*****

Post Results @Jeanne here 
...
The interaction term is not significant, indicating no meaningful difference in the increase of drug-related deaths between Oregon and Washington after the policy. This suggests that Oregon’s policy may not have had a distinct effect when compared to Washington. 

The high correlation between Oregon and Washington suggests that Washington is not an ideal control, as both states followed highly similar pre-policy trends. As a result, using Washington alone as a control underestimates the policy’s effect. On the other hand, using California, which had a different baseline and trend, highlights a significant impact of the policy.

Given these findings, the analysis supports using both California and Washington together as controls to balance the influence of broader national trends (represented by California) with regional factors (represented by Washington).
