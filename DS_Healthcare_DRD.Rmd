...
In this analysis, we ran two separate Difference-in-Differences (DiD) models to assess the impact of Oregon’s decriminalization policy on drug-related deaths per 100,000 inhabitants, using California and Washington as individual control groups. This decision was prompted by the discovery of a high correlation (0.95) between drug-related death trends in Oregon and Washington, which raised concerns about whether Washington was an appropriate control.
